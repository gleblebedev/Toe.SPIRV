...
{
    public class ShaderToScriptConverter
    {
        [Verb("genshadertoscriptconverter")]
        public class Options
        {
            ...
            [Option('o', "output", Required = false, HelpText = "ShaderToScriptConverterBase.cs full file path and name")]
