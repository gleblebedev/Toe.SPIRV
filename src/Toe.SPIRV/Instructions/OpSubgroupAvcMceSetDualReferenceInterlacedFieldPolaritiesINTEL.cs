...
namespace Toe.SPIRV.Instructions
{
    public partial class OpSubgroupAvcMceSetDualReferenceInterlacedFieldPolaritiesINTEL: InstructionWithId
    {
        ...
        {
            yield return new ReferenceProperty("ForwardReferenceFieldPolarity", ForwardReferenceFieldPolarity);
            yield return new ReferenceProperty("BackwardReferenceFieldPolarity", BackwardReferenceFieldPolarity);
