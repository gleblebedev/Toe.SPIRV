...
{
    public partial class GetKernelNDrangeMaxSubGroupSize : FunctionNode 
    {
        public GetKernelNDrangeMaxSubGroupSize(OpGetKernelNDrangeMaxSubGroupSize op, SpirvInstructionTreeBuilder treeBuilder)
        {
