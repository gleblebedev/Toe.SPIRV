...
{
    public partial class GroupCommitWritePipe : SequentialOperationNode 
    {
        public GroupCommitWritePipe(OpGroupCommitWritePipe op, SpirvInstructionTreeBuilder treeBuilder)
        {
