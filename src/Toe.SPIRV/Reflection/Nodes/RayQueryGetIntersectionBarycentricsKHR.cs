...
{
    public partial class RayQueryGetIntersectionBarycentricsKHR : Node
    {
        ...
        public void SetUp(OpRayQueryGetIntersectionBarycentricsKHR op, SpirvInstructionTreeBuilder treeBuilder)
        {
