...
{
    public partial class RayQueryGetIntersectionPrimitiveIndexKHR : Node
    {
        ...
        public void SetUp(OpRayQueryGetIntersectionPrimitiveIndexKHR op, SpirvInstructionTreeBuilder treeBuilder)
        {
