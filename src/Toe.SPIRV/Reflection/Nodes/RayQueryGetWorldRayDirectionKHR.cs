...
{
    public partial class RayQueryGetWorldRayDirectionKHR : Node
    {
        ...
        public void SetUp(OpRayQueryGetWorldRayDirectionKHR op, SpirvInstructionTreeBuilder treeBuilder)
        {
