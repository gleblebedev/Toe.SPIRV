...
{
    public partial class ReserveReadPipePackets : FunctionNode 
    {
        public ReserveReadPipePackets(OpReserveReadPipePackets op, SpirvInstructionTreeBuilder treeBuilder)
        {
