...
{
    public partial class SubgroupAvcImeConvertToMcePayloadINTEL : Node
    {
        ...
        public void SetUp(OpSubgroupAvcImeConvertToMcePayloadINTEL op, SpirvInstructionTreeBuilder treeBuilder)
        {
