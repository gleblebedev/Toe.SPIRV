...
{
    public partial class SubgroupAvcMceGetDefaultIntraChromaModeBasePenaltyINTEL : Node
    {
        ...
        public void SetUp(OpSubgroupAvcMceGetDefaultIntraChromaModeBasePenaltyINTEL op, SpirvInstructionTreeBuilder treeBuilder)
        {
