...
{
    public partial class SubgroupAvcSicConvertToMcePayloadINTEL : Node
    {
        ...
        public void SetUp(OpSubgroupAvcSicConvertToMcePayloadINTEL op, SpirvInstructionTreeBuilder treeBuilder)
        {
